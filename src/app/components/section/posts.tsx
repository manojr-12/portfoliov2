...
export default function BlogsSection() {
  return (
    <div className="pl-50 pb-50 section-shell" id="blogs">
      ...
      <div className="mt-20 flex flex-row flex-wrap pl-30 pr-30 blog-grid">
        {blogs.map((blog, index) => (
          <Link
            className="mr-15 mb-20 h-120 w-104 flex flex-col items-start justify-between shadow-sm blogs-card"
            href={`/blog/${index}`}
            key={index}
          >
            <AsyncImage
              ...
              className="bg-center blog-cover"
              Transition={Blur}
            />
